...
start /b "" ngrok http --url=pumped-together-chipmunk.ngrok-free.app 80
...
if "%NGROK_URL%"=="" (
    echo Error: Could not fetch ngrok URL. Ensure ngrok is running and pumped-together-chipmunk.ngrok-free.app is valid.
